...
title Windows Cleanup ^& Optimizer v6.1.5 - Ultimate Toolkit
...
:: ================= P1: RUNTIMES, BROWSERS, MESSAGING, MEDIA =================
:WingetInstall_P1
...
:: ================= P2: IMAGING, DOCS, STORAGE, SECURITY =================
:WingetInstall_P2
